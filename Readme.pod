...
with each other. All plugins are application and storage agnostic,
...
=item L<http://docs.oasis-open.org/xri/xrd/v1.0/xrd-1.0.html|XRD>

=item L<http://tools.ietf.org/html/draft-hammer-hostmeta|HostMeta>

=item L<http://code.google.com/p/webfinger/wiki/WebFingerProtocol|Webfinger>

=item L<http://salmon-protocol.googlecode.com/svn/trunk/draft-panzer-magicsig-01.html|MagicSignatures>

=item L<http://salmon-protocol.googlecode.com/svn/trunk/draft-panzer-salmon-00.html|Salmon>

=item ...

As Sojolicious is in its early stages, there is currently work on
support for C<ActivityStreams>, C<OAuth>, C<PubsubHubbub> and C<Portable Contacts>.
There are plans to expand the scope to other social protocols, for example C<OExchange>.
...
Thanks to a lot of other implementors for inspiring code (referenced in the sourcecode).
