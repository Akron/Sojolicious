...
=item L<Crypt-MagicSignatures-Key> and L<Crypt-MagicSignatures-Envelope>

=item L<Mojolicious::Plugin::PubSubHubbub|https://github.com/Akron/Mojolicious-Plugin-PubSubHubbub>

=item L<MojoX::XML|https://github.com/Akron/MojoX-XML> (Name will change soon)
...
However, you can use all separated parts published on CPAN.
