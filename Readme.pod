...
All plugins have no requirements other than L<Mojolicious> and Perl 5.10.1
(core modules).

Sojolicious is work in progress. There are missing parts currently developed
...
=item L<PubSubHubbub|https://pubsubhubbub.googlecode.com/svn/trunk/pubsubhubbub-core-0.3.html> (Now separated)
...
most of these protocols. There is no stable release at GitHub or CPAN.

There are plans to expand the scope to other social protocols,
...
C<PubSubHubbub> was developed by Brad Fitzpatrick, Brett Slatkin, and Martin Atkins.
